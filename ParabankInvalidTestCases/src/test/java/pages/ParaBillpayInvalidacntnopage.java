...
public class ParaBillpayInvalidacntnopage {
	WebDriver driver;
  ...
  By login=By.xpath("//*[@id='loginPanel']/form/div[3]/input");
	...
	public ParaBillpayInvalidacntnopage(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void customerBillPay() throws InterruptedException
	{
		...
		driver.findElement(payeename).sendKeys("arshu");
		...
		driver.findElement(accountno).sendKeys("6543657123");
